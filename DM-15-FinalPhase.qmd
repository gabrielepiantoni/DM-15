...
```{r}
#Graphs: Real GDP - OECD, ASIANTIGERS and DEVCOUNTRIES
GDP |>
...
```{r}
GDP |>
  filter(EasternEurope=="YES") |>
  filter(TIME_PERIOD>=1995)|>
  ggplot(aes(x=TIME_PERIOD, y=RealGDPperCapita, color=Pays)) +
  geom_line()
```
